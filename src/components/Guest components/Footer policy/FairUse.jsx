        ...
        <div className=" gap-6 border border-white rounded-lg bg-setting_profile_bg lg:p-5 items-start">
          <div className="bg-setting-profile-bg p-8 rounded-md">
            ...
            <p className="text-white text-sm mb-6">
              ...
              acceptable and unacceptable use of our platform to ensure
              compliance with applicable laws, third-party terms of service, and
              ethical standards. By using NetworkX.ai, you agree to abide by
              this Policy.
            </p>
            <p className="text-white text-sm mb-6">
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <li>
                Engagement tools such as following, unfollowing, liking,
                unliking, reposting, and unreposting.
              </li>
              <li>
                Any other current or future features, services, or
                functionalities offered through the NetworkX.ai platform.
              </li>
            </ul>
            <h2 className="text-text text-xl font-semibold mb-3">
              2. Acceptable Use
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
              ...
              <li>
                Using automation for harassment, abuse, or spreading hate
                speech.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
              <li>
                Using data obtained through X’s API or our platform in a way
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
              <li>
                Attempting to bypass our or X’s technical limits, such as DM
                caps, post limits, or engagement thresholds.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
              <li>
                Using NetworkX.ai to provide automation services or tools to
                third parties for resale or commercial use without permission.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
              ...
              <li>
                OpenAI’s{" "}
                <span className="text-secondary underline">
                  <a href="https://openai.com/usage-policies">
                    {" "}
                    Usage Policies.
                  </a>
                </span>
            ...
            <p className="py-2 text-sm">
              ...
              responsible for ensuring that the input you provide aligns with
              all applicable guidelines and policies. The final decision
              regarding the use of AI-generated content, including its posting
              and distribution, rests with you.
            </p>
            ...
            <p className="text-white text-sm mb-4">
              ...
              does not guarantee compliance with X’s terms, advertising
              policies, or other third-party rules. By using our platform, you
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <li>
                NetworkX.ai is not responsible for changes to third-party
                services (e.g., X’s API changes or OpenAI’s policies) that
                affect the operation or functionality of our platform.
              </li>
            </ul>
            ...
            <p className="text-white text-sm mb-4">
              NetworkX.ai reserves the right to update this Policy at any time
              to reflect changes in our services, legal requirements, or
              industry standards. Changes will take effect upon posting on our
              website. Continued use of the platform constitutes acceptance of
              the updated Policy.
            </p>
            <h2 className="text-text text-xl font-semibold mb-3">
