...
const Affiliate = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollY > 0) {
        // Set solid state as soon as scrolling starts
        setIsSolid(true);
        setIsBlurred(false);
      } else {
        // Reset states when at the top of the page
        setIsSolid(false);
        setIsBlurred(false);
      }
    };
        ...
        <div className=" gap-6 border border-white rounded-lg bg-setting_profile_bg lg:p-5 items-start">
          <div className="bg-setting-profile-bg p-8 rounded-md">
            ...
            <p className="text-white text-sm mb-6">
              ...
              which affiliates ("Affiliates," "You," or "Your") participate in
              the NetworkX.ai Affiliate Program ("Program") and promote the
              software solutions provided by NetworkX.ai ("Company," "We," "Us,"
              or "Our"). By participating in this Program, you agree to be bound
              by the terms set forth in this Policy.
            </p>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <p className="py-2">
                NetworkX.ai reserves the right to monitor affiliate activities
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <li className="text-nowrap">
                ...
                advertising laws, data protection laws, and intellectual
                property rights.
              </li>
              <li>
                Not engage in deceptive or misleading marketing practices,
                including false claims, spam, or unauthorized use of
                NetworkX.ai's trademarks and branding.
              </li>
              <li>
                Promote the Affiliate Links provided by NetworkX.ai in a manner
                that does not infringe upon the rights of third parties or
                create confusion as to the nature of your relationship with
                NetworkX.ai.
              </li>
              ...
              <li>
                Sending unsolicited emails (spam) to promote your affiliate
                link.
              </li>
              <li>
            ...
            <p className="text-white text-sm mb-4">
              ...
              NetworkX.ai's software products and services made through the
              unique affiliate links they promote.
            </p>
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <strong className="text-text">Commission Structure:</strong>
              <p>
                The commission structure is detailed in the Affiliates section
                of the NetworkX.ai settings page and may vary by product or
                service. Affiliates will earn a percentage of the net sale price
                (after applicable taxes, discounts, and refunds).
              </p>
              ...
              <ul className="list-disc list-inside pl-6">
                ...
                <li>
                  <strong>Payment Method:</strong> Payments will be processed
                  via PayPal. If you do not have a PayPal account, you may
              ...
              <p>
                Affiliates are responsible for reporting and paying any
                applicable taxes on their commission earnings in accordance with
                local laws. NetworkX.ai does not withhold taxes on behalf of
                affiliates.
              </p>
              <strong className="block py-2 text-text">
              ...
              <p>
                Participation in the Program does not guarantee any specific
                level of income. Earnings depend on your efforts, marketing
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <li>
                ...
                annoy or trick potential customers into clicking on the
                affiliate link.
              </li>
              <li>
            ...
            <p className="text-white text-sm mb-4">
              ...
              California Consumer Privacy Act (CCPA), and other relevant privacy
              laws.
            </p>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                ...
                Program, you are granted a non-exclusive, non-transferable
                license to use NetworkX.ai’s trademarks, logos, and other
                marketing materials provided by the Company to promote the
                Program.
              </li>
              <li>
                Ownership: You acknowledge that all intellectual property
                rights, including copyrights and trademarks, in the materials
                provided by NetworkX.ai remain the exclusive property of
                NetworkX.ai.
              </li>
              <li>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              ...
              <p className="py-2">
                ...
                NetworkX.ai, and all pending commission payments will be
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <p className="text-white text-sm mb-4">
                NetworkX.ai will not be liable for any indirect, consequential,
                or punitive damages arising from an affiliate’s participation in
                the Program.
              </p>
              <p className="text-white text-sm mb-4">
                Affiliates agree to indemnify, defend, and hold harmless
                NetworkX.ai, its officers, directors, and employees, from and
                against any claims, damages, or legal actions resulting from
                their actions, omissions, or breach of this Agreement, including
                but not limited to:
              </p>
              <li>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <p className="text-white text-sm mb-4">
                NetworkX.ai reserves the right to monitor affiliate activities
                and conduct audits to detect and prevent fraudulent activity.
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <p className="text-white text-sm mb-4">
                NetworkX.ai reserves the right to modify or update this
                Affiliate Program Policy at any time. Any changes will be
                communicated to the affiliates, and continued participation in
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <p className="text-white text-sm mb-4">
                ...
                from this Agreement will be resolved through binding arbitration
                in New York, United States of America or through any other
