        ...
        p-8 rounded-md"
          >
            ...
            <p className="text-white text-sm mb-6">
              NetworkX.ai ("we," "our," or "us") is committed to safeguarding
              the privacy of our users. This Privacy Policy outlines how we
              collect, use, and protect your information when you use our
              platform and services.
            </p>
            <p className="text-white text-sm mb-6">
              By accessing or using NetworkX.ai, you agree to this Privacy
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                ...
                sign up, we collect information such as your name, email
                address, phone number, username, password, payment information,
                and any
              </li>
              <li>
                <span className="font-bold">User Content:</span> Data inputted
                into our platform, including messages, posts, replies, prompts
            ...
            <p className=" font-bold">
              b. Information We Collect Automaticallye
            </p>
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                <span className="font-bold">Usage Data:</span>Information such
                as IP address, browser type, device information, interaction
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                ...
                from X’s API to provide automation and engagement tools. This
                may include account metrics, posts, follower details, and
                interactions related to your account.
              </li>
              <li>
                <span className="font-bold"> OpenAI Integration:</span> We
                process content using OpenAI’s ChatGPT-4-Turbo to generate
                posts, replies, and other content. OpenAI may process this data
                in accordance with their privacy terms.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                <span className="font-bold">To Provide Services:</span>To
                deliver core features such as DM automation, AI-generated
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                ...
                third-party vendors (e.g., payment processors, hosting
                providers, OpenAI, X) to facilitate our services.
              </li>
              <li>
              ...
              <li>
                ...
                Where you explicitly agree to data sharing for specific
                purposes.
              </li>
            </ul>
            <h2 className="text-text text-xl font-semibold mb-3">
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                <span className="font-bold">Integration with X:</span>Your use
                of NetworkX.ai requires integration with X (formerly Twitter).
                Your data may be shared with X as part of their API
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                <span className="font-bold">Access:</span> Request access to
                your personal data.
              </li>
              <li>
                <span className="font-bold">Correction</span> Request
              ...
              <li>
                <span className="font-bold">Opt-Out: </span> Opt-out of
                marketing communications or data collection practices (e.g.,
                cookies).
              </li>
              <p className="py-1">
            ...
            <ul className="list-disc list-inside text-white text-sm mb-4">
              <li>
                <span className="font-bold">Necessary Cookies:</span>For
            ...
            <p className=" py-1 text-sm">
              If you access NetworkX.ai from outside the United States, note
              that your data will be transferred and processed in the United
              States. We take measures to ensure your data is handled securely
            ...
            <p className=" py-1 text-sm">
              ...
              be effective upon posting the updated policy on our website. We
