      ...
      <div className=" gap-6 border border-white rounded-lg bg-setting_profile_bg lg:p-5 items-start">
        <div className="bg-setting-profile-bg p-8 rounded-md">
          ...
          <p className="text-white text-sm mb-6">
            Welcome to NetworkX.ai! These Terms of Service ("Terms") govern your
          ...
          <p className="text-white text-sm mb-4">
            NetworkX.ai provides tools and automation for managing accounts on X
            (formerly Twitter), including:
          </p>
          <ul className="list-disc list-inside text-white text-sm mb-4">
            <li>
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            <li>
              Use the Services to spam, harass, or violate the rights of others.
            </li>
            ...
            <li>Introduce viruses, malware, or other harmful technologies.</li>
            <p className="text-white text-sm mb-4">
          ...
          <p className="text-white text-sm mb-4">
            ...
            platform must comply with X’s terms, and we are not responsible for
            any changes X may implement that affect the functionality of our
            Services. Users acknowledge that changes to X's API or its rate
            limits may restrict the functionality of the Services.
          </p>
          ...
          <p className="text-white text-sm mb-4">
            Access to certain features of the Services requires a subscription.
            Fees are detailed on our pricing page and are subject to change with
            notice.
          </p>
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            ...
            <p className="font-sm py-1">
              ...
              NetworkX.ai or its affiliates be liable for any indirect, special,
              ...
              with the use or inability to use the services, regardless of
              whether NetworkX.ai has been advised of the possibility of such
              damages. NetworkX.ai’s liability under these Terms shall be
              limited to the amount you have paid for the services during the
          ...
          <p className="text-white text-sm mb-4">
            ...
            employees harmless from claims, damages, losses, or expenses arising
            from:
          </p>
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            ...
            <p className="py-1">
              Upon termination, you must cease all use of the Services, and any
          ...
          <p className="text-white text-sm mb-4">
            ...
            take effect upon posting on our website. Continued use of the
