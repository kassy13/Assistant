      ...
      <div className=" gap-6 border border-white rounded-lg bg-setting_profile_bg lg:p-5 items-start">
        <div className="bg-setting-profile-bg p-8 rounded-md">
          ...
          <p className="text-white text-sm mb-6">
            This Data Processing Agreement ("Agreement") is entered into by and
            between NetworkX.ai ("Processor") and the user ("Data Controller" or
            "User") of the NetworkX.ai platform, effective as of the date the
            user agrees to the terms herein. This Agreement governs the
            processing of personal data provided by the User through the use of
            NetworkX.ai’s services.
          </p>
          <p className="text-white text-sm mb-6">
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4">
            ...
            <p className="py-2">
              The User, as the Data Controller, determines the specific Personal
              Data that will be processed through the platform, and NetworkX.ai
              will process it only according to the User’s instructions.
              NetworkX.ai may also process additional data as necessary to
              provide the full range of services and for legitimate business
              purposes, such as analytics, support, or improving functionality.
              All such processing will be in compliance with applicable data
              protection laws and the terms of this Agreement.
            </p>
          </ul>
          ...
          <p className="text-white text-sm mb-4">
            In the course of providing its services, NetworkX.ai may process the
            following categories of Personal Data:
          </p>
          <ul className="list-disc list-inside text-white text-sm mb-4">
            <li>
              Contact information (e.g., usernames, email addresses, passwords).
            </li>
            ...
            <p className="py-2">
              ...
              genetic or biometric data, health-related information, or data
              related to criminal convictions and offenses.
            </p>
          </ul>
          ...
          <p className="text-white text-sm mb-4">
            ...
            continues to use the platform. Upon termination of the User’s use of
            the service, NetworkX.ai will retain and securely delete or
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4">
            ...
            <li>
              ...
              applicable data protection laws, including responding to Data
              Subject requests and reporting any data breaches.
            </li>
            <li>
              ...
              NetworkX.ai ensures that sub-processors comply with the same data
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4">
            ...
            <li>
              ...
              Data will be used, including through this Agreement and applicable
              privacy notices.
            </li>
            <li>
          ...
          <p className="text-white text-sm mb-4">
            ...
            Data against unauthorized access, loss, destruction, or alteration.
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4">
            ...
            <p className="py-2">
              NetworkX.ai will cooperate with the User in handling the breach in
          ...
          <p className="text-white text-sm mb-4">
            ...
            restriction, portability, and objection. NetworkX.ai will assist the
            User in fulfilling these requests, as reasonably necessary and
          ...
          <p className="text-white text-sm mb-4">
            ...
            jurisdictions, subject to the conditions and safeguards required by
            applicable data protection laws. Specifically:
          </p>
          <ul className="list-disc list-inside text-white text-sm mb-4">
            <li>
            ...
            <li>
              ...
              NetworkX.ai will ensure that appropriate safeguards are in place
              when transferring Personal Data from the EU to other countries.
              These safeguards include but are not limited to Standard
              Contractual Clauses (SCCs) and adequacy decisions made by the
              European Commission where applicable.
            </li>
            <li>
              <strong className="font-bold">Other Jurisdictions:</strong>
              NetworkX.ai will comply with local data protection laws, including
              the California Consumer Privacy Act (CCPA), Brazil’s General Data
              Protection Law (LGPD), and other applicable privacy regulations in
              other countries. Users are responsible for ensuring that their use
              of the platform complies with the relevant laws in their
              jurisdiction.
            </li>
          ...
          <p className="text-white text-sm mb-4">
            The Data Controller has the right to audit or request an independent
            audit of NetworkX.ai’s data processing activities to verify
            compliance with this Agreement. Such audits will be conducted with
            reasonable notice and at the User’s expense.
          </p>
          <h2 className="text-text text-xl font-semibold mb-3">
          ...
          <p className="text-white text-sm mb-4">
            ...
            requirements or as a result of changes in our business. Any updates
            to this Agreement will be posted on our website, and continued use
          ...
          <p className="text-white text-sm mb-4">
            If you have any questions or concerns regarding this Data Processing
            Agreement, or if you would like to exercise your rights, please
            contact us at:
          </p>
          <ul>
