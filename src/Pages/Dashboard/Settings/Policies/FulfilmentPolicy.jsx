        ...
        <div className="bg-setting-profile-bg p-8 rounded-md ">
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            <li className="pb-1">
              ...
              period. Additional credits can be purchased separately as needed.
            </li>
            <li className="pb-1">
              <span className="font-bold">Pay-Per-Credit Plan:</span> {""}
              Credits are added to your account upon successful payment and can
              be used to access specific features or services as outlined in
              your plan.
            </li>
            <li className="pb-1">
            ...
            <li className="pb-1">
              ...
              Additional features or services available for purchase to enhance
              your plan. These are activated immediately after successful
          ...
          <p className="py-1 text-sm">
            ...
            service, functionality may be affected by changes or disruptions in
            third-party APIs. We are not responsible for downtime or limitations
          ...
          <p className="py-1 text-sm">
            ...
            cyberattacks, technical failures of third-party platforms, or any
          ...
          <p className="py-1 text-sm">
            ...
            services. During maintenance windows, access to certain features may
          ...
          <p className="py-1 text-sm">
            Upon successful registration and subscription payment, your account
            will be activated, and you can start using NetworkX.ai immediately.
            You are responsible for providing accurate information during
            registration.
          </p>
          <p className=" font-bold font-sm">b. Onboarding Assistance</p>
          <p className="py-1 text-sm">
            We provide guides and customer support to help you get started with
            our platform. For assistance, contact{" "}
          ...
          <p className="py-1 text-sm">
            NetworkX.ai operates on a recurring subscription model. The billing
            frequency (monthly, annually, etc.) is determined by the plan you
            select during purchase.
          </p>
          <p className=" font-bold font-sm">b. Auto-Renewal</p>
          <p className="py-1 text-sm">
            Your subscription will automatically renew at the end of each
            billing cycle unless you cancel. You can manage your subscription in
            your account’s settings section.
            <span className="font-bold">support@networkx.ai.</span>
          </p>
          ...
          <p className="py-1 font-sm">
            All payments made to NetworkX.ai are final and non-refundable due to
            the digital nature of our services. Refunds may be issued solely at
            NetworkX.ai's discretion in exceptional circumstances. These
            include, but are not limited to:
          </p>
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            <li className="">
              Proven technical issues entirely attributable to NetworkX.ai that
              prevented service usage.
            </li>
            ...
            <p className="py-1 font-sm">
              ...
              right to approve or deny refund requests on a case-by-case basis,
          ...
          <p className=" font-bold font-sm">a. Compliance with X’s Policies</p>
          <p className="py-1 font-sm">
            ...
            Exceeding X’s guidelines—such as sending excessive direct messages,
            posts, or performing high volumes of actions—may lead to account
            restrictions, suspensions, or other penalties imposed by X.
          </p>
          ...
          <ul className="list-disc list-inside text-white text-sm mb-4 pl-3">
            <li className="">
              It is your responsibility to stay informed about X’s policies and
              ensure your usage remains compliant.
            </li>
            <li className="">
              NetworkX.ai is not liable for any consequences resulting from
              misuse or overuse of the platform that violates X’s spam policies
              or usage guidelines.
            </li>
          </ul>
          ...
          <p className="py-1 font-sm">
            ...
            performance of third-party platforms. NetworkX.ai is not liable for
            disruptions caused by changes or outages in these services.
          </p>
          <p className=" font-bold font-sm">
            d. Service Suspension and Termination
          </p>
          <p className="py-1 font-sm">
            NetworkX.ai reserves the right to suspend or terminate accounts that
            engage in activities violating our terms of service or applicable
            laws. Accounts may also be suspended for unresolved payment issues
          ...
          <p className="py-1 font-sm">
            ...
            our Services, including features and pricing, at any time with prior
            notice. These changes will not affect your subscription for the
...
export default FulfilmentPolicy;
